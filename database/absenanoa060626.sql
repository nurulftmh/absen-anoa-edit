...
--
-- Host: localhost:3306
-- Generation Time: Jun 06, 2026 at 07:13 AM
...
(99, 20, '2026-06-05', '08:01:56', '16:54:11', 'hadir', '2026-06-05 08:01:56', '2026-06-05 16:54:11'),
(100, 19, '2026-06-05', '08:08:32', '17:12:30', 'hadir', '2026-06-05 08:08:32', '2026-06-05 17:12:30'),
(101, 18, '2026-06-05', '08:34:45', '16:50:49', 'hadir', '2026-06-05 08:34:45', '2026-06-05 16:50:49'),
(102, 17, '2026-06-05', '10:13:22', NULL, 'hadir', '2026-06-05 10:13:22', '2026-06-05 10:13:22'),
(105, 18, '2026-06-06', '07:44:59', NULL, 'hadir', '2026-06-06 07:44:59', '2026-06-06 07:44:59'),
(106, 20, '2026-06-06', '08:07:18', NULL, 'hadir', '2026-06-06 08:07:18', '2026-06-06 08:07:18'),
(107, 19, '2026-06-06', '07:07:01', NULL, 'hadir', '2026-06-06 11:07:01', '2026-06-06 11:07:01'),
(108, 17, '2026-06-06', '08:10:59', NULL, 'hadir', '2026-06-06 11:10:59', '2026-06-06 11:10:59');
...
CREATE TABLE `books` (
  ...
  `docs_link` text COLLATE utf8mb4_unicode_ci,
...
(50, 18, '2026-06-05', 'Prof.Dr.Ir. Anas Nikoyan, M.Si.', 'MEMBANGUN KELEMBAGAAN DALAM PENGEMBANGAN MASYARAKAT', NULL, 'Selesai', 'Assalamualaikum Pak. Saya kirim draf yang sdh baca/sedikit tambahan dan catatan penjelasannya. Mohon dibantu tata ulang semoga bisa memenuhi sebagai buku teks. Terima kasih 🙏🏼', '2026-06-05 11:36:11', '2026-06-05 17:02:45');
...
INSERT INTO `leave_requests` (`id`, `user_id`, `date`, `reason`, `proof_file`, `status`, `created_at`, `updated_at`, `is_read`) VALUES
(24, 20, '2026-06-06', 'sakit', NULL, 'rejected', '2026-06-05 16:08:52', '2026-06-06 08:07:18', 1),
(25, 17, '2026-06-06', 'sakit', NULL, 'rejected', '2026-06-05 16:36:16', '2026-06-06 11:10:59', 1),
(27, 17, '2026-06-07', 'sakit', NULL, 'rejected', '2026-06-06 03:39:21', '2026-06-06 03:40:07', 1),
(28, 17, '2026-06-07', 'tes', NULL, 'rejected', '2026-06-06 06:54:46', '2026-06-06 07:05:58', 1);
...
(40, 19, 'Rasmaniar', 'Risk Factors of Stunting among Toddlers Aged 6–36 Months in a Coastal Community of Soropia, Indonesia: A Case-Control Study', 'https://jnhrc.com.np/', NULL, 'Submitted', NULL, 'manuscripts/QHM6bq9djxQkmIwOJwDSpMKI0TrubQK7STuUkWxF.png', '2026-05-21 15:12:23', '2026-06-05 16:10:56'),
...
(15, '2026_06_04_110949_create_published_books_table', 12);
...
CREATE TABLE `published_books` (
  ...
  `book_pdf_path` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `certificate_archive_path` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `note` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `published_books` (`id`, `user_id`, `published_date`, `author_name`, `title`, `isbn`, `publisher`, `cover_path`, `book_pdf_path`, `certificate_archive_path`, `note`, `created_at`, `updated_at`) VALUES
(1, 17, '2026-06-08', 'penulis', 'judul1', NULL, 'anoa', 'published-books/covers/zNhtfb1rczhK0xxYKWsd1XYifGaPVKDqgxr8959y.jpg', 'published-books/pdfs/XAfybvcRoU7iFisB9Yeww9kY3qD8ALigGQ75FDLw.pdf', 'published-books/certificates/1mGoE82hmHWpFHS8cBEX8wuduFRhvHDFz0U7Zrub.rar', NULL, '2026-06-06 06:13:10', '2026-06-06 06:13:10');
...
('kaaWwIm2D3eeoamnmKHyZiCEH6NSE7MBKG93t0jC', 17, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36 Edg/148.0.0.0', '', 1780729631),
('RvVMywvBfl3oNtUuzZNz4sP6yPSMVWIQCmu6hDsp', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36 Edg/148.0.0.0', 'eyJfdG9rZW4iOiIwaEpCUmJvdVZxRVRWQWRlWVF3MGxieDJjbHhpbXJta1AyT1Q0WTFQIiwiX2ZsYXNoIjp7Im9sZCI6W10sIm5ldyI6W119LCJfcHJldmlvdXMiOnsidXJsIjoiaHR0cDpcL1wvMTI3LjAuMC4xOjgwMDAiLCJyb3V0ZSI6bnVsbH19', 1780725634),
('wLqv8KSN2wpmkG0v6QfdwTQs380ZOyXKlFxF9gHQ', 17, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36 Edg/148.0.0.0', '', 1780723721);
...
(19, 'Yuni Maulidya Kaplale', 'ymaulidya66@gmail.com', NULL, '$2y$12$OrO//g5/RPR5zdhcerCrYeIYJ5eU/yAkYwEXWPT3jHUqebwfBk55K', 'HG37aBFkbRva2JgQ0JGxuzQSPeVIOOSRqVDa1qGArw3D7pqSvX17vAfiJd20', '2026-05-12 15:06:52', '2026-05-12 15:06:52', 'user'),
...
(25, 42, 'work-files/qLpkdvwBoaILvQiil62MDt9psUfOlWiwa70mCrKC.docx', 'KURIKULUM PRODI TEKNIK KOMPUTER.docx', '2026-06-05 16:51:27', '2026-06-05 16:51:27');
...
(41, 100, 'melakukan submit manuscript ibu rasmaniar di JNHRC', '2026-06-05 16:10:22', '2026-06-05 16:10:22'),
(42, 101, 'Menyelesaikan Kurikulum Prodi Teknik Komputer', '2026-06-05 16:51:27', '2026-06-05 16:51:27'),
(43, 99, 'Hari ini saya mengerjakan revisi buku Kelembagaan dalam Pengembangan Masyarakat', '2026-06-05 16:54:01', '2026-06-05 16:54:01');
...
ALTER TABLE `published_books`
  ADD PRIMARY KEY (`id`),
  ADD KEY `published_books_user_id_foreign` (`user_id`);
...
--
-- Constraints for table `published_books`
--
ALTER TABLE `published_books`
  ADD CONSTRAINT `published_books_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
